...
class Database {
    ...
    public function upsert_record( array $record ) {
        ...
        $data = [
            ...
            'url'              => $record['url'] ?? null,
            'categories'       => isset( $record['categories'] ) ? wp_json_encode( (array) $record['categories'] ) : null,
            'filters'          => isset( $record['filters'] ) ? wp_json_encode( (array) $record['filters'] ) : null,
            'custom_fields'    => isset( $record['custom_fields'] ) ? wp_json_encode( (array) $record['custom_fields'] ) : null,
